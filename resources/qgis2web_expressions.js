...
function exp_label_Nivelderiesgoenlasreas_9_eval_expression(context) {
    // Area || '  m2' || '\n' || 'Riesgo: ' || Riesgo

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((feature.get('Area')  + '  m2') + '\n') + 'Riesgo: ') + feature.get('Riesgo') );
    } else {
        return ((((feature.get('Area')  + '  m2') + '\n') + 'Riesgo: ') + feature.get('Riesgo') );
    }
}
...
function exp_label_Linderosdelasreasdeestudio_11_eval_expression(context) {
    // Distance || ' m' || '\n' || Rumbo
